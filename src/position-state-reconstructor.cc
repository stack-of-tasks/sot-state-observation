...
namespace sotStateObservation
{
    ...
    PositionStateReconstructor::PositionStateReconstructor
        ...
        dt_(0.005),
        inputSIN(0x0 ,
                "PositionStateReconstructor("+inName+")::input(vector)::input"),
        inputFormatSIN(0x0 ,
                "PositionStateReconstructor("+inName+")::input(string)::inputFormat"),
        outputFormatSIN(0x0 ,
                "PositionStateReconstructor("+inName+")::input(string)::outputFormat"),
        outputSOUT( inputSIN<<inputFormatSIN<<outputFormatSIN,
                "PositionStateReconstructor("+inName+")::output(vector)::output")
    {
        ...
        inputFormatSIN.setConstant("000000");
        outputFormatSIN.setConstant("000000");
                ...
                (dynamicgraph::Vector & output, const int& inTime)
    {
        ...
        std::string inputFormat (inputFormatSIN(inTime));
        std::string outputFormat (outputFormatSIN(inTime));
